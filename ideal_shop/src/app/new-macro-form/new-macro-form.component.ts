...
@Component({
  selector: 'app-new-macro-form',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './new-macro-form.component.html',
  styleUrls: ['./new-macro-form.component.css', '../shared.css']
})
export class NewMacroFormComponent {
  ...
  ngOnChanges(){ // S'active quand @Input change
    ...
    getMinMax(array: any){
      this.findMinAndMax(array);
      this.attributionAfterMinMax();
    }
